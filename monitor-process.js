...
(function () {
  const APP_RESOURCES = {
    finder: { cpu: [1, 3], ram: [70, 120], gpu: [2, 5] },
    notes: { cpu: [0.5, 2], ram: [40, 80], gpu: [1, 2] },
    calculator: { cpu: [0.5, 1], ram: [30, 50], gpu: [1, 2] },
    settings: { cpu: [1, 2], ram: [60, 100], gpu: [2, 4] },
    monitor: { cpu: [3, 5], ram: [80, 120], gpu: [5, 8] },
    store: { cpu: [2, 4], ram: [100, 180], gpu: [5, 10] },
    browser: { cpu: [3, 8], ram: [200, 400], gpu: [8, 15] },
    weather: { cpu: [1, 2], ram: [50, 90], gpu: [2, 3] },
    terminal: { cpu: [0.5, 1], ram: [25, 45], gpu: [1, 2] },
    music: { cpu: [2, 4], ram: [80, 150], gpu: [4, 6] },
    paint: { cpu: [3, 6], ram: [100, 200], gpu: [8, 12] },
    clock: { cpu: [0.5, 1], ram: [30, 60], gpu: [2, 3] },
    calendar: { cpu: [1, 2], ram: [60, 100], gpu: [3, 5] },
    gamecenter: { cpu: [8, 15], ram: [350, 550], gpu: [15, 25] },
    videoeditor: { cpu: [10, 20], ram: [450, 750], gpu: [20, 35] },
    wallpapers: { cpu: [2, 5], ram: [120, 250], gpu: [8, 12] },
    aichat: { cpu: [2, 5], ram: [150, 300], gpu: [3, 6] }
  };
  ...
  function getAppUsage(appName) {
    ...
    const config = APP_RESOURCES[key] || { cpu: [1, 3], ram: [60, 100], gpu: [2, 5] };
